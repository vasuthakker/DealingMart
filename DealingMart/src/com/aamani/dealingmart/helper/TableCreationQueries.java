...
public class TableCreationQueries {
	...
	public static List<String> getCreateTableQueries() {
		...
		tableCreationQueries
				.add("CREATE TABLE IF NOT EXISTS DEALINGMART_CART(_ID INTEGER PRIMARY KEY AUTOINCREMENT,PRODUCT_ID TEXT NOT NULL,PRODUCT_NAME TEXT NOT NULL,PRODUCT_IMAGE NOT NULL,PRODUCT_PRICE INTEGER NOT NULL)");
